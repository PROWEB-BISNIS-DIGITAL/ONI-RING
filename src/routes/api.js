...
router.get('/managementU', async (req, res) => {
    try {
        ...
        const data = {
            ...
            chart_laba: {
                total_laba_kotor: labaBulanIni + pengeluaranBulanIni
            },
            chart_pengeluaran: {
                modal: modalBulanIni,
...
// ✅ TAMBAHKAN INI: Route untuk Omset Range Tanggal
router.get('/keuangan/omset/range', keuanganController.getOmsetByRange);

// ============ LABA RUGI ROUTES (AJAX) ============
router.get('/keuangan/laba-rugi', keuanganController.getLabaRugi);
// ✅ TAMBAHKAN INI: Route untuk Laba Rugi Range Tanggal
router.get('/keuangan/laba-rugi/range', keuanganController.getLabaRugiByRange);
